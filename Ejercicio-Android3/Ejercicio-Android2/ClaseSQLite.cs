...
namespace Ejercicio_Android2
{
    public class ClaseSQLite
    {
        ...
        public bool IngresarDatos(string Nombre, string Domicilio,
                ...
                var RutaBase = Path.Combine
                    (System.Environment.GetFolderPath
                        (System.Environment.SpecialFolder.Personal),
                            basededatos);
                var conexion = new SqliteConnection("Data Source="
                    + RutaBase);
                conexion.Open();
        ...
        public void Buscar(int folio)
        {
            try
            {
                ...
                {
                    contenido.CommandText = "SELECT * FROM DATOS WHERE Folio='" +
                    folio + "';";
